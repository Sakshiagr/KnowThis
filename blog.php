        ...
        <main class="d-flex align-items-center justify-content-center flex-column">
            <div class="d-flex align-items-center justify-content-center flex-wrap p-5" style="width : 90%">
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <p class="tm-pt-30" style='margin-right:20px;'>
                    ...
                    <div class="d-flex justify-content-between tm-pt-45">
                        ...
                        <span class="tm-color-primary">June 04,2023</span>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between">
                        <span>0 comments</span>
                        <span>by Sakshi Agrawal</span>
                    </div>
                </article>
                <article class="col-12 col-md-6 tm-post">
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <div class="d-flex justify-content-between tm-pt-45">
                        ...
                        <span class="tm-color-primary">August 05,2023</span>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between">
                        <span>0 comments</span>
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <div class="d-flex justify-content-between tm-pt-45">
                        ...
                        <span class="tm-color-primary">September 05,2024</span>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between">
                        <span>0 comments</span>

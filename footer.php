                        ...
                        <div class="white-link">
                            <div class="d-flex pb-3">
                                <div class="avatar avatar-lg rounded">
                                    <img src="https://electricskyline.ie/wp-content/uploads/2022/02/female-profile-placeholder.png" title="" alt="">
                                </div>
                                <div class="col ps-3">
                                    <small class="text-white-65">20BCE2923</small>
                                    <h6 class="font-w-500 h6 m-0"><a class="text-white" href="#">Sakshi Agrawal</a></h6>
                                </div>
                            </div>
                            <div class="d-flex">
